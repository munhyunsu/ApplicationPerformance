...
from pcap2har.http import common as http
from pcap2har.http import message
...
#        from pcap2har.BeautifulSoup import UnicodeDammit
#except ImportError:
#    UnicodeDammit = None
            ...
            if encoding == 'gzip' or encoding == 'x-gzip':
                try:
                    gzipfile = gzip.GzipFile(
                        fileobj = io.BytesIO(self.raw_body)
                    )
